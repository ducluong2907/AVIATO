                            ...
                            <div class="col-xl-12 col-lg-7" style="height: 100%">
                                <div class="card shadow mb-4">
                                    ...
                                    <div
                                        ...
                                        <form action="filterpost" >
                                            ...
                                            <span >
                                                ...
                                                <select name="status" >
                                                    ...
                                                    <option ${0==requestScope.status? "selected" : "" } value="0" >Not active</option>
                                                </select>
                                            </span>
                                            <span >
                                                Status
                                                <select name="category" >
                                                    <option  value="-1">All</option>
                                                    <option ${1==requestScope.cate? "selected" : "" } value="1">Clean Shoes</option>
                                                    <option ${2==requestScope.cate? "selected" : "" } value="2" >Custom Shoes</option>
                                                    <option ${3==requestScope.cate? "selected" : "" } value="3" >Recovery Shoes</option>
                                                    <option ${4==requestScope.cate? "selected" : "" } value="4" >Repair Shoes</option>
                                                </select>
                                            </span>
                                        ...
                                        <button> <a href="addBlog.jsp" style="color: black"> Add Blog </a> </button>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="a" items="${requestScope.lstPost}">
                                                <tr>
                                                    <td>${a.blogID}</td>
                                                    <td class="">${a.title}</a></td>
                                                    <td><p style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;min-width: 0; width: 250px">${a.content}</p></td>
                                                    ...
                                                    <td style="text-align: center"><b>${a.cateBlogID.cateBlogID}</b></td>
                                    ...
                                    <!--</div>-->
                                    <!--</div>-->
                                    <c:if test="${requestScope.action eq 'lstpost'}">
                                        <div class="text-center">
                                            <ul class="pagination post-pagination" style="display: inline">
                                                <a href="lstpost?id=${idPage-1}" style="font-size: 15px"> <<  </a>
                                                <c:forEach begin="1" end="${numberPage}" var="i">

                                                    <a style ="${idPage==i?'color: red':""}; 

                                                       padding-left: 10px; padding-right: 10px"  href="lstpost?id=${i}"  >${i}  </a>
                                    ...
                                    <c:if test="${requestScope.action eq 'filterpost'}">
                                        <div class="text-center">
                                            <ul class="pagination post-pagination" style="display: inline">
                                                <a href="filterpost?status=${requestScope.status}&category=${requestScope.cate}&id=${idPage-1}" style="font-size: 15px"> <<  </a>
                                                <c:forEach begin="1" end="${numberPage}" var="i">

                                                    <a style ="${idPage==i?'color: red':""}; 

                                                       padding-left: 10px; padding-right: 10px"  href="filterpost?status=${requestScope.status}&category=${requestScope.cate}&id=${i}"  >${i}  </a>
                                    ...
                                    <c:if test="${requestScope.action eq 'searchpost'}">
                                        <div class="text-center">
                                            <ul class="pagination post-pagination" style="display: inline">
                                                <a href="searchpost?key=${requestScope.key}&id=${idPage-1}" style="font-size: 15px"> <<  </a>
                                                <c:forEach begin="1" end="${numberPage}" var="i">

                                                    <a style ="${idPage==i?'color: red':""}; 

                                                       padding-left: 10px; padding-right: 10px"  href="searchpost?key=${requestScope.key}&id=${i}"  >${i}  </a>
