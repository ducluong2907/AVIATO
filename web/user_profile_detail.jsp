                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="dashboard-wrapper dashboard-user-profile">
                            <div class="media">
                                <c:set var="a" value="${sessionScope.UserTemp}"></c:set>
                                    <div class="pull-left text-center">
                                        <img class="media-object user-img" src="images/shop/user/${a.avatar}" alt="Image">
                                </div>
                                ...
                                <div class="media-body">
                                    ...
                                    <ul class="user-profile-list" style="margin-bottom: 30px">
                                        ...
                                        <li><span>Address</span>${a.address}</li>
                                        <li><span>Phone</span>${a.phone}</li>
                                        <li><span>Date of Birth</span>${a.dob}</li>
                                    </ul>
                                    <div class="col-md-12">
                                        <a href="updateuser" class="btn btn-main btn-large btn-round-full">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
