    ...
    <body id="reportsPage">
        <div class="" id="home">
            <nav class="navbar navbar-expand-xl">
                <div class="container h-100">
                    <a class="navbar-brand" href="index.html">
                        <h1 class="tm-site-title mb-0">Sale Manager</h1>
                    </a>
                    <button
            ...
            <div class="container mt-5">
                ...
                <div class="row tm-content-row">
                    ...
                    <div class="tm-block-col tm-col-account-settings">
                        <div class="tm-bg-primary-dark tm-block tm-block-settings">
                            ...
                            <form action="userprofile"  method="POST" class="tm-signup-form row">
                                <%--<c:forEach var="item" items="${UserTemp}">--%>
                                <div class="form-group col-lg-6">
                                    <label for="name">Account Name</label>
                                    <input id="name" name="fname" type="text" class="form-control validate"/>${UserTemp.name}
                                </div>
                                <div class="form-group col-lg-6">
                                    <label for="email">Account Email</label>
                                    <input id="email" name="email" type="email" class="form-control validate" readonly />
                                </div>
                                <div class="form-group col-lg-6">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select id="gender" class="custom-select">
                                        <option value="male" class="form-control validate">Male</option>
                                        <option value="female" class="form-control validate">Female</option>
                                    </select>
                ...
                <c:if test="${mess!=null}"><h3>${mess}</h3></c:if>
                </div>
