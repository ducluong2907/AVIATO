                ...
                <table>
                    ...
                    <tr class="tr_insert">
                        ...
                        <td class="td_content_des">
                            <textarea name="desc" cols="41" rows="5" required></textarea>
                        </td>
                    </tr>
                    <tr class="tr_insert">
                        <td class="td_titles">
                    ...
                    <tr>
                        ...
                        <td class="td_content_cate">
                            38 <input type="text" name="size38" style="width: 200px;height: 30px;margin-top: 20px;border: 1px solid gray" required><br/>
                            39 <input type="text" name="size39" style="width: 200px;height: 30px;margin-top: 20px;border: 1px solid gray" required><br/>
                            40 <input type="text" name="size40" style="width: 200px;height: 30px;margin-top: 20px;border: 1px solid gray" required><br/>
                            41 <input type="text" name="size41" style="width: 200px;height: 30px;margin-top: 20px;border: 1px solid gray" required ><br/>
                            42 <input type="text" name="size42" style="width: 200px;height: 30px;margin-top: 20px;border: 1px solid gray" required><br/>
                            43 <input type="text" name="size43" style="width: 200px;height: 30px;margin-top: 20px;border: 1px solid gray" required>
                        </td>
                    </tr>
                    <tr>
                        <td>
