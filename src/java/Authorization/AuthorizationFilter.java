...
public class AuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
            ...
            if (u == null) {
                ...
                if (r == 1) {
                    ...
                    if(r == 2 ) {
                        ...
                        hsResponse.sendRedirect("mktDashboard");
                    }
                    else {
                        hsResponse.sendRedirect("home");
                    }
                }
            }
        }
        ...
        if (url.equals("/mktDashboard") || url.equals("/postlist") 
                || url.equals("/postdetail")) {
            if (u == null) {
                hsResponse.sendRedirect("login");
            }
            else {
